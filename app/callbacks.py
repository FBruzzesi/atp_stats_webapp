...
sys.path.append("..")
from utils.tennis import PlayerDataLoader, PlayerRenderer, get_player_name
...
def select_player(player_name):
    ...
    tourney_opt = [
        {"label": t, "value": t} for t in sorted(player_matches["tourney_name"].unique())
    ]
    opponents_opt = [
        {"label": o, "value": o} for o in sorted(player_matches["opponent_name"].unique())
    ]
    ...
    return [
        player_matches.to_json(date_format="iso"),
